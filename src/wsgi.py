...
# web application at http://sg41.pythonanywhere.com/
...
# import sys
#
# assuming your django settings file is at '/home/sg41/mysite/mysite/settings.py'
# and your manage.py is is at '/home/sg41/mysite/manage.py'
# path = '/home/sg41/mysite'
# if path not in sys.path:
#    sys.path.append(path)
#
...
#
#
# The "/home/sg41" below specifies your home
# directory -- the rest should be the directory you uploaded your Flask
# code to underneath the home directory.  So if you just ran
# "git clone git@github.com/myusername/myproject.git"
# ...or uploaded files to the directory "myproject", then you should
# specify "/home/sg41/myproject"
path = '/home/sg41/gemini-server'
if path not in sys.path:
    sys.path.append(path)
#
